...
export default function NavBar(props) {
    ...
    return (
        <div className="navbar">
                ...
                {/*<h1>Notelad</h1>*/}
                <svg className="headerlogo" id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 937 937">
  <defs>
    <style>
      {/* .cls-1 {
        fill: #fff;
  ...
  <g>
    <path className="cls-1555" d="M500,956A456.12,456.12,0,0,1,322.51,79.83a456.12,456.12,0,0,1,355,840.34A453,453,0,0,1,500,956Z" transform="translate(-31.5 -31.5)"/>
