...
const [converterStyle, setConverterStyle] = useState("EditorConverter");
 ...
 const wrapperRef = useCallback(wrapper => {
    ...
    return (
        ...
        <div id="Editor">
          ...
          <div onClick={onMenuClickHandler}  className="menuButtonArea">
              ...
              <svg className="MenuButton" alt="MBUTTON"id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 938 938">
  <defs>
  ...
  <g>
    <path class="cls-3 first" d="M679,384H259a15,15,0,0,1-15-15h0a15,15,0,0,1,15-15H679a15,15,0,0,1,15,15h0A15,15,0,0,1,679,384Z"/>
